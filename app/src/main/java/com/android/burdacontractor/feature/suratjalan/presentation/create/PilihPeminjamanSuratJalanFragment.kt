...
import com.android.burdacontractor.databinding.FragmentPilihPeminjamanBinding
...
class PilihPeminjamanSuratJalanFragment : DialogFragment() {
    ...
    override fun onCreateView(
        ...
        _binding = FragmentPilihPeminjamanBinding.inflate(inflater, container, false)
        return binding.root
    }
    ...
    private fun initUi() {
        with(binding) {
            ...
            binding.rvPeminjaman.layoutManager = gridLayoutManager
            binding.rvPeminjaman.addOnScrollListener(object : RecyclerView.OnScrollListener() {
