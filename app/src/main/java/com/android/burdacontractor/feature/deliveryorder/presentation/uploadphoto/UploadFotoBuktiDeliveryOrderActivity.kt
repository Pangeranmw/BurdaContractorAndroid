...
class UploadFotoBuktiDeliveryOrderActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        uploadFotoBuktiDeliveryOrderViewModel.liveNetworkChecker.observe(this){
            checkConnection(snackbar,it){ initObserver() }
        }
    }
    private fun initObserver() {
        uploadFotoBuktiDeliveryOrderViewModel.state.observe(this) {
            when (it) {
        ...
        uploadFotoBuktiDeliveryOrderViewModel.messageResponse.observe(this) {
    ...
    private fun initUI(){
        with(binding){
            ...
            deliveryOrder?.fotoBukti.let{
                ...
                tvFotoBukti.setTextColor(ContextCompat.getColor(this@UploadFotoBuktiDeliveryOrderActivity,R.color.black))
                ivCurrentFotoBukti.setVisible()
                ivCurrentFotoBukti.setImageFromUrl(it,this@UploadFotoBuktiDeliveryOrderActivity)
            }
        }
    ...
    private fun uploadImage() {
        currentImageUri?.let { uri ->
            ...
            uploadFotoBuktiDeliveryOrderViewModel.uploadFotoBukti(deliveryOrder!!.id, imageFile)
