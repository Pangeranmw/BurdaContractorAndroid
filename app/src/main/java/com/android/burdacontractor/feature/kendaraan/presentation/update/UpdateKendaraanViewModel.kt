...
@HiltViewModel
class UpdateKendaraanViewModel @Inject constructor(
    val liveNetworkChecker: LiveNetworkChecker,
    private val updateKendaraanUseCase: UpdateKendaraanUseCase,
) : ViewModel() {
    ...
    fun updateKendaraan(
        ...
        viewModelScope.launch {
            updateKendaraanUseCase.execute(id, gudangId, jenis, merk, platNomor, gambar).collect {
                when (it) {
