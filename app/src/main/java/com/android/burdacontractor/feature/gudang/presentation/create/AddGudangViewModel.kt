...
@HiltViewModel
class AddGudangViewModel @Inject constructor(
    val liveNetworkChecker: LiveNetworkChecker,
    private val addGudangUseCase: AddGudangUseCase,
    ...
    fun addGudang(
        ...
        viewModelScope.launch {
            addGudangUseCase.execute(nama, alamat, provinsi, kota, latitude, longitude, gambar)
                .collect {
                    when (it) {
